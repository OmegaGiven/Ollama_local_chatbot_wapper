...
def create_sidebar():
     with st.sidebar:
        ...
        return selected_model, document_text, think, stream, remember_history, repo_text
...
def setup_ui():
    ...
    selected_model, document_text, think, stream, remember_history, repo_text = create_sidebar()
